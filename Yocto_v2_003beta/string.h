...
const char txt_INST0[] PROGMEM   =" BD";
const char txt_INST1[] PROGMEM   =" SD";
const char txt_INST2[] PROGMEM   =" LT";
const char txt_INST3[] PROGMEM   =" MT";
const char txt_INST4[] PROGMEM   =" HT";
const char txt_INST5[] PROGMEM   =" RM";
const char txt_INST6[] PROGMEM   =" CP";
const char txt_INST7[] PROGMEM   =" CB";
const char txt_INST8[] PROGMEM   =" CY";
const char txt_INST9[] PROGMEM   =" OH";
const char txt_INST10[] PROGMEM  =" CH";
const char txt_INST11[] PROGMEM  ="PC2";
const char txt_INST12[] PROGMEM  ="ACC";
const char txt_INST13[] PROGMEM  ="EXT";
const char txt_INST14[] PROGMEM  ="TR1";
const char txt_INST15[] PROGMEM  ="TR2";
